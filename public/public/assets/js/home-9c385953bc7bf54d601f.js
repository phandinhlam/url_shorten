...
var Home = /*#__PURE__*/function () {
  ...
  _createClass(Home, [{
    key: "submitForm",
    value: function submitForm(form, data, callback) {
      $.ajax({
        url: form.action,
        type: form.method,
        cache: false,
    ...
    value: function bindEvent() {
      var _this = this;
      $('.encode-form')[0].addEventListener('submit', function (e) {
        _this.encode(e);
      });
      $('.decode-form')[0].addEventListener('submit', function (e) {
        _this.decode(e);
      });
    }
  }]);
...
/******/ });
//# sourceMappingURL=home-9c385953bc7bf54d601f.js.map